        ...
        .authorizeHttpRequests(
            auth ->
                auth.requestMatchers(HttpMethod.OPTIONS, "/**")
                    ...
                    .permitAll()
                    .requestMatchers(HttpMethod.GET, "/reservas/ocupadas")
                    .permitAll()
                    ...
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.POST, "/servicios")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.PUT, "/servicios/**")
                    .hasRole("ADMIN")
                    .requestMatchers(HttpMethod.DELETE, "/servicios/**")
                    .hasRole("ADMIN")
